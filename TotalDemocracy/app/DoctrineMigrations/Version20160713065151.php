...
class Version20160713065151 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE tasks (id VARCHAR(255) NOT NULL, user_id VARCHAR(255) DEFAULT NULL, date_created DATETIME NOT NULL, type VARCHAR(255) NOT NULL, service VARCHAR(255) NOT NULL, function VARCHAR(255) NOT NULL, json_params LONGTEXT NOT NULL, min_seconds NUMERIC(10, 4) NOT NULL, when_processed DATETIME DEFAULT NULL, INDEX IDX_50586597A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
